...
config :signal_nuisance,
  ecto_repos: [SignalNuisance.Repo]
...
config :signal_nuisance, SignalNuisanceWeb.Endpoint,
  ...
  live_view: [signing_salt: "feJzj9Ia"]
...
config :signal_nuisance, SignalNuisance.Mailer, adapter: Swoosh.Adapters.Local
